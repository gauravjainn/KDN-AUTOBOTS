        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.locationsContainer}>
                    ...
                    <Text style={styles.TextStyleFb}> Please select start Location </Text>
                    ...
                    <GooglePlacesAutocomplete
                        ...
                        listViewDisplayed={this.state.showPlacesListSource}
                        enablePoweredByContainer={false}
                        onChangeText={ValueHolder => this.GetValueFunction(ValueHolder)}
                        textInputProps={{
                            onFocus: () => this.setState({ showPlacesListSource: true }),
                            onBlur: () => this.setState({ showPlacesListSource: false }),
                        }}
                        ...
                        onPress={(data, details = null) => { // 'details' is provided when fetchDetails = true
                            ...
                            sourcelat = parseFloat(details.geometry.location.lat)
                            sourcelong = parseFloat(details.geometry.location.lng)
                            ...
                            this.setState({ source: initialsource })

                            console.log("sourcelat===" + sourcelat);
                            console.log("sourcelong===" + sourcelong);
